...
import { RotateCcw, Sparkles, GripVertical, Shuffle, ArrowLeftRight } from 'lucide-react';
...
import { ValidateButton, ValidationStatus } from '../ValidateButton.tsx';
...
export const SequencingInteractive: React.FC<SequencingInteractiveProps> = ({
  ...
  const validationStatus: ValidationStatus = !isChecked
    ? 'idle'
    : isCorrect
      ? 'correct'
      : 'incorrect';
