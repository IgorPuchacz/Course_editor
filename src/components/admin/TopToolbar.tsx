...
export const TopToolbar: React.FC<TopToolbarProps> = ({
  ...
  if (isTextEditing) {
    return (
      <div className={`top-toolbar relative z-50 flex items-center justify-between bg-white border-b border-gray-200 px-4 lg:px-6 py-3 ${className}`}> 
  ...
  return (
    <div className={`relative z-50 flex items-center justify-between bg-white border-b border-gray-200 px-4 lg:px-6 py-3 ${className}`}>
