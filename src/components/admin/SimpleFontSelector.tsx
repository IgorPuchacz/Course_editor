...
export const SimpleFontSelector: React.FC<SimpleFontSelectorProps> = ({
        ...
        <>
          ...
          <div className="absolute top-full left-0 mt-2 w-72 bg-white border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden">
            ...
            <div className="px-4 py-3 bg-gray-50 border-b border-gray-100">
              <h3 className="text-sm font-semibold text-gray-800">Wybierz czcionkę</h3>
              <p className="text-xs text-gray-600 mt-1">Podstawowe czcionki dla treści edukacyjnych</p>
            </div>
